...
/**
 * Una Lista enlazada es una agrupación de nodos, de los
 * que el primero se denomina cabeza(head).
 * Puede agregar y eliminar nodos, coómo también
 * obtener su tamaño.
 * 
...
public class LinkedList {    
     ...
     * @return Devuelve el tamaño de la linkedList
     */
     ...
     * @return Nodo que está al inicio de la linkedList
     */
    public Node getHead(){
        return head;
    }
    ...
    /**
     * getLength Devuelve el tamaño de la linkedList
     * @return Tamaño de la linkedList
     */
